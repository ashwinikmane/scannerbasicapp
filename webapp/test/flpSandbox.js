		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Scanner Basoic app",
									"targetURL": "#scannerbasicapp-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"scannerbasicapp-display": {
								"semanticObject": "scannerbasicapp",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=scannerbasicapp",
									"url": sap.ui.require.toUrl("scannerbasicapp")
								}
							}
						}
					}
